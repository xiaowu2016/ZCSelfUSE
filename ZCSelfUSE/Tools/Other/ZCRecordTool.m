...
#define ZCRecordFileName @"zcRecord.caf"

@interface ZCRecordTool ()<AVAudioRecorderDelegate>
/**
 *  录音文件地址
 */
...
- (AVAudioRecorder *)recorder
{
    if(_recorder == nil)
    {
        ...
        NSString *filePath = [path stringByAppendingPathComponent:ZCRecordFileName];
        //2.转换成URL
...
static ZCRecordTool *instance = nil;
